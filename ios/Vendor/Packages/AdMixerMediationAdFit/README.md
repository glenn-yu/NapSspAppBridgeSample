...
**AdMixerMediationAdFit**은 AdMixerMediation SDK 기반으로 **AdFit SDK**와 연동을 제공하는 Swift Package Manager(SPM) 패키지입니다.
...
2. https://github.com/Nasmedia-Tech/iOS-SSP-AdFit-SPM.git 를 입력하세요. 
